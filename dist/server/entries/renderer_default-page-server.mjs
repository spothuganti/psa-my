...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "layout" }, _attrs))} data-v-b5167d8d><div class="navigation" data-v-b5167d8d><a href="/" class="logo" data-v-b5167d8d><img${ssrRenderAttr("src", _imports_0)} height="64" width="64" data-v-b5167d8d></a>`);
      ...
      _push(`</div><div class="content" data-v-b5167d8d>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</div></div>`);
    };
  }
...
const PageShell = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b5167d8d"]]);
